...
const projectsData = [
        ...
        Document: [ {name: 'Abstract', url: 'https://drive.google.com/file/d/17uASAvXpSnKULEACQHKC2witXGM5x7-K/view?usp=sharing' }] },
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/MedSRGAN-Pytorch',
    },
    {
        ...
        documents: [
            ...
            { name: 'Presentation Slides', url: 'https://drive.google.com/file/d/1dnvu1GGh_7tMwaMeIa4KfDsS5XVjdPEt/view?usp=sharing' }
        ],
    },
    ...
    // === Other Data Science Code and Research ===
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/product-relevance-learning-to-rank',
    },
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/Intel-image-classification-pt-lightning',
    },
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/heart-disease-classification-clustering',
    },
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/bank_marketing',
    },
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/ECG_analysis',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1-49sBcZUqQdGTLdnojijUX-qtRf4LYQb/view?usp=sharing',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1ZjAFL6rkgvE03Fz1c51QIEJCRUMzTuXS/view?usp=sharing',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1gf5bucTvGTfUmbE2RSrtm2aAnZjTpdxP/view?usp=sharing',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1pSa9tgk7QVzU7qB2sKERJm8TlzPX41Lj/view?usp=sharing',
    },
    ...
    // === Operations Research ===
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/BnB_BFS/',
    },
    {
        ...
        Document: 'https://github.com/parsakhavarinejad/TSP_optimization',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1lSK8pzzptAqNt0tZrHi1uuoT-KfPsqyD/view?usp=sharing',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1IK9zYNgTtjdAdPXUtqLvt_tddWwQbnbd/view?usp=drive_link',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1fK-eQyXDeL2dzQ5JognolcCJ-egqcTh4/view?usp=sharing',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1_jyMQeiWz6S0t86Ft_ymTz20s_jLZG5y/view?usp=sharing',
    },
    {
    ...
    // === Game Theory ===
    {
        ...
        Document: 'https://drive.google.com/file/d/1WxSn9dy-VRFQaqdf5054e0Z_mIsFOpWw/view?usp=sharing',
    },
    {
        ...
        Document: 'https://drive.google.com/file/d/1lXDnSTSRkHgxpGMPwGj5ZtiAS-RWtoqL/view?usp=sharing',
    },
    ...
    // === Other Topics ===
    {
        ...
        Document: 'https://drive.google.com/file/d/1N_pAyFXT0ch-dyPtl_jKcFh4kk14iREB/view?usp=sharing',
    },
...
/**
 * Populates the projects section, handling links as objects with names and URLs.
 */
function populateProjects() {
    ...
    projectsGrid.className = 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6';
    ...
    projectsData.forEach(project => {
        ...
        if (project.documents && Array.isArray(project.documents)) {
            ...
            // We now map over an array of objects (doc), not an array of strings (url).
            linksHtml = project.documents.map(doc => {
                // Use doc.url for the link and doc.name for the display text.
                return `<a href="${doc.url}" target="_blank" rel="noopener noreferrer" class="text-[#FF69B4] hover:text-[#00FFFF] transition-colors font-semibold">${doc.name}</a>`;
            }).join('');

        } else if (project.Document) {
            linksHtml = `<a href="${project.Document}" target="_blank" rel="noopener noreferrer" class="text-[#FF69B4] hover:text-[#00FFFF] transition-colors font-semibold">View Document</a>`;
        }

        projectCard.innerHTML = `
            <div class="w-full aspect-video overflow-hidden">
                <img src="${project.image}" alt="Project image for ${project.title}" onerror="this.onerror=null;this.src='https://placehold.co/600x400/0A0A0A/00FFFF?text=PROJECT';" class="w-full h-full object-cover">
            </div>
