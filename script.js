document.addEventListener('DOMContentLoaded', function () {
    ...
    const projectsData = [
        ...
        // === Operations Research ===
        {
            image: 'images/milp_optimization.webp',
        ...
        {
            image: 'images/tsp_optimization.webp',
    ...
    function populateTimeline(containerId, data, clickHandler) {
        ...
        data.forEach((item, index) => {
            ...
            div.innerHTML = `
                ...
                <p class="text-xs text-[#bdd5ea]">${item.period}</p>
            `;
    ...
    function updateDetails(detailsContainerId, data, id) {
        ...
        if (item) {
            const detailsHtml = `
                ...
                <p class="text-sm text-[#bdd5ea] mb-4">${item.period}</p>
                <ul class="list-disc pl-5 space-y-2 text-[#bdd5ea]">
